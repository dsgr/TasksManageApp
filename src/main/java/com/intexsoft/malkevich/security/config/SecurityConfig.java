...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/").permitAll()
				...
				.antMatchers(HttpMethod.POST, "/api/task/add").hasAnyAuthority("ROLE_ADMIN", "ROLE_MANAGER")
				.antMatchers(HttpMethod.GET, "/api/task/delete").hasAnyAuthority("ROLE_ADMIN", "ROLE_MANAGER")
				.antMatchers(HttpMethod.GET, "/api/task/setuser").hasAnyAuthority("ROLE_ADMIN", "ROLE_MANAGER")
				.antMatchers(HttpMethod.GET, "/api/task/setstatus").hasAnyAuthority("ROLE_ADMIN", "ROLE_MANAGER")
